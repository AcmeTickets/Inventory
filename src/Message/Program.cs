...
var endpointName = "Inventory.Message";
...
public class NServiceBusHostedService : IHostedService
{
    ...
    {
        _logger.LogInformation("Starting NServiceBus endpoint Inventory.Message");
    ...
    public async Task StopAsync(CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogInformation("Stopping NServiceBus endpoint Inventory.Message");
